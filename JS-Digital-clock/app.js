...
let clock = () => {
    ...
    hours = ( hours < 10 ) ? newHours = "0" + hours : newHours = hours;

    // Zero is added if minutes is between 0 and 9
    minutes = ( minutes < 10 ) ? newMinutes = "0" + minutes : newMinutes = minutes;

    // Zero is added if seconds is between 0 and 9
    seconds = ( seconds < 10 ) ? newSeconds = "0" + seconds : newSeconds = seconds;
